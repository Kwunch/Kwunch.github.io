        ...
        <>
            ...
            <section class="view" id="sec:aboutme" style="display: block">
                ...
                <div class="col">
                        ...
                        Computer Science, a BS in Quantum Computing and Physics, and a BA in Mathematics. \
                        ...
                        which can be referenced in the Resume section. Rust is my preferred language for \
                ...
                <div class="col">
                    <section class = "sub">
                        ...
                        <h4><p>{"Programming is not just career pursuit for me, it is also one of my primary hobbies. \
                         I am consistently expanding my GitHub with new projects and ideas. My pique interests now \
                        ...
                        <h4><p>{" While most of my projects may be in C or Rust, I have a firm understanding
