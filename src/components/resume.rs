    ...
    html! {
        <section class="view" id="sec:resume">
          ...
          <div class="top_left_col">
            ...
            <h3 class="resume_headers"><a id="pdf_resume" href="https://drive.proton.me/urls/ZNW5NYVAFR#ypYOygHRhAki" target="_blank">
          ...
          <div class="middle_left">
            <section class="sub">
              ...
              <h4><li>{"Leaving space here for grad school ;)"}</li></h4>
            </section>
            </div>
